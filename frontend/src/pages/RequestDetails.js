              ...
              {role === "PROCUREMENT_OFFICER" && (
                <>
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-xs font-semibold ring-1 ring-black/5 ${
        ...
        <div className="mb-4">
          <div className="bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl p-2 shadow-sm inline-flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-semibold ring-1 ${
                mainTab === "details"
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-semibold ring-1 ${
                          activeTab === "offers"
                            ? "bg-white text-slate-900 ring-white/40"
                            : "bg-white/20 text-white ring-white/25 hover:bg-white/30"
                        }`}
                  ...
                  {showRpBar && (
                    <div className="flex gap-2 justify-end">
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-white text-xs font-semibold shadow transition ring-1 ring-white/20 ${
                          computing || evaluations.length > 0
                    ...
                    <div className="mt-2 max-h-[70vh] overflow-y-auto pr-2 pb-10 scroll-pb-10 rounded-xl">
                      <div className="space-y-4">
                        {offers.map((o) => (
                          <div
                            key={o.id}
                            className={`p-4 border rounded-xl flex flex-col gap-3 transition ring-1 ring-black/5 ${
                              isPreferred(o.id)
                              ...
                              {role === "RESOURCE_PLANNER" && (
                                <div className="flex items-center gap-2 justify-end">
                                  <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-xs font-semibold shadow transition ring-1 ring-white/20 ${
                                      rpCanFinalApprove && isPreferred(o.id)
                                        ? "bg-emerald-600 text-white hover:bg-emerald-700"
                                        : "bg-gray-300 text-gray-600 cursor-not-allowed"
                                    }`}
                                    type="button"
