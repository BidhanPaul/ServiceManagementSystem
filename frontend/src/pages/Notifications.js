            ...
            {thread.messages.map((m) => {
              const isMine = m.dm?.from === username;
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className={`max-w-[75%] border rounded-2xl p-3 shadow-sm ${isMine
                                    ...
                                    >
                                        <div className="flex justify-between items-start gap-3">
                                            <div>
                                                ...
                                                <p
                                                    className={`text-[11px] mt-2 ${isMine ? "text-white/80" : "text-slate-500"
                                                        }`}
                                                >
          ...
          >
            ...
            Direct Messages ({dmThreads.length})
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-full text-sm font-semibold ${activeTab === "SYSTEM"
